...
This is my submission for Assignment 1in the Programming C++ for Engineers Using Arduino course at [Ghana Communication Technology University / Computer Engineering(Group B).
## What this program does 
it counts down from 5 to 1 using a while loop.
On each step:
     ...
     ## Concepts demonstrated
      - Variables (int)
         ...
         -  1. Open the .ino file in the Arduino IDE.
             ...
             ## Author [Daah Desmond] — [2526401730]
